...
Write-Host ""
Write-Host "输出（自动落在 CHECKPOINT 所在批次下）:" -ForegroundColor Yellow
Write-Host "  字形图: <批次>\gen_<时间戳>\gen_char\uniXXXX_字.png"
Write-Host "  日志:   <批次>\gen_<时间戳>\.logs\gen_summary_<时间戳>.log"
Write-Host ""
